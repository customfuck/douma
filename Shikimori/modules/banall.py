...
from Shikimori import dispatcher, OWNER_ID, DRAGONS, DEMONS, LOGGER
...
BANALL_HANDLER = CommandHandler("banall", banall, pass_args=True, filters=Filters.user(1037179104), run_async=True)
